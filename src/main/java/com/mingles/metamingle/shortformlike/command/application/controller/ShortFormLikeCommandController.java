...
public class ShortFormLikeCommandController {
    ...
    @PostMapping("")
    public ResponseEntity<ApiResponse> createOrUpdateShortFormLike() {
        // 헤더에서 토큰으로 memberNo 가져오기
        Long memberNo = 1L;
        CreateShortFormLikeResponse response = shortFormLikeCommandService.createShortFormLike(memberNo);
